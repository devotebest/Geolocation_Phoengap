(function($, DX, undefined) {
    ...
    DX.framework.html.SlideOutController = DX.framework.html.DefaultLayoutController.inherit({
        ...
        _createNavigation: function(navigationCommands) {
            ...
            this.$slideOut = $("<div/>").appendTo(this._$hiddenBag).dxSlideOut({menuItemTemplate: $("#slideOutMenuItemTemplate"), swipeEnabled: false}).dxCommandContainer({id: 'global-navigation'});
