MyApp.artist_page_search = function (params) {
...
//  Put the binding properties here
    ...
    var venue_no = artist.location_id;
    /* To be added at a later date. JMR 20171109.
    <span class="venue_no sba_pink">' + venue_no + '</span>
    */
    ...
    if (location.length != 0) {
        ...
        location_name_link = '<div class="button_holder profile_page"><p class="location_name_link" onClick=\"MyApp.app.navigate(\'map_page_2/' + location[0].id + '\');"><span class="dx-button-text"><i class="fa fa-map-marker icon-margin-right sba_pink"></i>' + location[0].title + '</span></p></div>';
        
        location_name_link_back = location[0].title;
    }
    var main_pic = '<img src="images/artist_pics/' + artist.id + '.jpg" />';
